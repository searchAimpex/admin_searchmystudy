...
import { deleteAbroadStudy } from "../slice/AbroadSlice";
import { toast } from "react-toastify";
import { fetchMbbsStudy } from "../slice/MbbsSlice";
import CreateMbbsForm from "../form/CreateMbbsForm";
import DataTable from "react-data-table-component";

const MbbsCountryManager = () => {
  const dispatch = useDispatch();
  const [selectedIds, setSelectedIds] = useState([]);
  const [showModal, setShowModal] = useState(false);
  const [studyMbbs, setStudyMbbs] = useState([]);
...
export default MbbsCountryManager;